...
//    System.out.println(carSn + "\t" + carName + "\t" + carYesr + "\t" + carOwner + "\t" + carPrice + "\t" +  carType);
    ...
    carInfoPrint(car);
    //이걸 만듬으로써 주석 방식이 필요없어짐

  }
  //Q. 매개변수로  자동차의 정보르 받아서 출력하는 메서드를 정의하시오
//  public static void carInfoPrint(int carYear, String carOwner, String carName, int carPrice, int carSn, String carType) {
//
//  }
  public static void carInfoPrint(CarDTO car){
    System.out.println(car.carName + "\t" + car.carPrice + "\t" + car.carSn + "\t" + car.carType +  "\t" + car.carYear + "\t" + car.carOwner);
  };
